...
export interface SimulatedTotalSupplyArgs {
  reserve: TransactionObjectInput;
  clock: TransactionObjectInput;
}

/**
 * Move function: `simulated_total_supply`
 ...
 */
export function simulatedTotalSupply(
  tx: Transaction,
  typeArg: string,
  args: SimulatedTotalSupplyArgs,
): TransactionResult {
  return tx.moveCall({
    target: `${PUBLISHED_AT}::reserve::simulated_total_supply`,
