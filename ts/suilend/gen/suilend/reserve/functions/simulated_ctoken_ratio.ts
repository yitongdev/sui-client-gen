...
export interface SimulatedCtokenRatioArgs {
  reserve: TransactionObjectInput;
  clock: TransactionObjectInput;
}

/**
 * Move function: `simulated_ctoken_ratio`
 ...
 */
export function simulatedCtokenRatio(
  tx: Transaction,
  typeArg: string,
  args: SimulatedCtokenRatioArgs,
): TransactionResult {
  return tx.moveCall({
    target: `${PUBLISHED_AT}::reserve::simulated_ctoken_ratio`,
