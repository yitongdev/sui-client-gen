...
export class BCS implements StructClass {
  ...
  static readonly $typeName = `${PKG_V35}::bcs::BCS`;
  static readonly $numTypeParams = 0;
  static readonly $isPhantom = [] as const;

  readonly $typeName = BCS.$typeName;
  readonly $fullTypeName: `${typeof PKG_V35}::bcs::BCS`;
  readonly $typeArgs: [];
  ...
  static reified(): BCSReified {
    return {
      ...
      fullTypeName: composeSuiType(BCS.$typeName, ...[]) as `${typeof PKG_V35}::bcs::BCS`,
      typeArgs: [] as [],
