...
export function isExtensionKey(type: string): boolean {
  ...
  return type.startsWith(`${PKG_V35}::kiosk_extension::ExtensionKey` + "<");
}
  ...
  implements StructClass
{
  ...
  readonly $fullTypeName: `${typeof PKG_V35}::kiosk_extension::ExtensionKey<${PhantomToTypeStr<T0>}>`;
  ...
  private constructor(
    ...
    this.$fullTypeName = composeSuiType(
      ...
      ...typeArgs,
    ) as `${typeof PKG_V35}::kiosk_extension::ExtensionKey<${PhantomToTypeStr<T0>}>`;
