...
export function isNitroAttestationDocument(type: string): boolean {
  ...
  return type === `${PKG_V35}::nitro_attestation::NitroAttestationDocument`;
}
...
export class NitroAttestationDocument implements StructClass {
  ...
  static readonly $typeName = `${PKG_V35}::nitro_attestation::NitroAttestationDocument`;
  static readonly $numTypeParams = 0;
  static readonly $isPhantom = [] as const;

  readonly $typeName = NitroAttestationDocument.$typeName;
  readonly $fullTypeName: `${typeof PKG_V35}::nitro_attestation::NitroAttestationDocument`;
  readonly $typeArgs: [];
  ...
  private constructor(typeArgs: [], fields: NitroAttestationDocumentFields) {
    this.$fullTypeName = composeSuiType(
      ...
      ...typeArgs,
    ) as `${typeof PKG_V35}::nitro_attestation::NitroAttestationDocument`;
