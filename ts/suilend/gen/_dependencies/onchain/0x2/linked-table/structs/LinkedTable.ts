...
> implements StructClass
{
  ...
  static readonly $typeName = `${PKG_V35}::linked_table::LinkedTable`;
  static readonly $numTypeParams = 2;
  static readonly $isPhantom = [false, true] as const;

  readonly $typeName = LinkedTable.$typeName;
  readonly $fullTypeName: `${typeof PKG_V35}::linked_table::LinkedTable<${ToTypeStr<T0>}, ${PhantomToTypeStr<T1>}>`;
  ...
  private constructor(
    ...
    this.$fullTypeName = composeSuiType(
      ...
      ...typeArgs,
    ) as `${typeof PKG_V35}::linked_table::LinkedTable<${ToTypeStr<T0>}, ${PhantomToTypeStr<T1>}>`;
  ...
  >(
    ...
    return {
      ...
      ) as `${typeof PKG_V35}::linked_table::LinkedTable<${ToTypeStr<ToTypeArgument<T0>>}, ${PhantomToTypeStr<ToPhantomTypeArgument<T1>>}>`,
