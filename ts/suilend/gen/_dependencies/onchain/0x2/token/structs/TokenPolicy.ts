...
export function isTokenPolicy(type: string): boolean {
  ...
  return type.startsWith(`${PKG_V35}::token::TokenPolicy` + "<");
}
...
export class TokenPolicy<T0 extends PhantomTypeArgument> implements StructClass {
  ...
  static readonly $typeName = `${PKG_V35}::token::TokenPolicy`;
  static readonly $numTypeParams = 1;
  static readonly $isPhantom = [true] as const;

  readonly $typeName = TokenPolicy.$typeName;
  readonly $fullTypeName: `${typeof PKG_V35}::token::TokenPolicy<${PhantomToTypeStr<T0>}>`;
  ...
  private constructor(typeArgs: [PhantomToTypeStr<T0>], fields: TokenPolicyFields<T0>) {
    this.$fullTypeName = composeSuiType(
      ...
      ...typeArgs,
    ) as `${typeof PKG_V35}::token::TokenPolicy<${PhantomToTypeStr<T0>}>`;
  ...
  static reified<T0 extends PhantomReified<PhantomTypeArgument>>(
    ...
    return {
      ...
      fullTypeName: composeSuiType(
        TokenPolicy.$typeName,
        ...[extractType(T0)],
      ) as `${typeof PKG_V35}::token::TokenPolicy<${PhantomToTypeStr<ToPhantomTypeArgument<T0>>}>`,
