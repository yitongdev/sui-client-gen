...
export function isRuleKey(type: string): boolean {
  ...
  return type.startsWith(`${PKG_V35}::token::RuleKey` + "<");
}
...
export class RuleKey<T0 extends PhantomTypeArgument> implements StructClass {
  ...
  static readonly $typeName = `${PKG_V35}::token::RuleKey`;
  static readonly $numTypeParams = 1;
  static readonly $isPhantom = [true] as const;

  readonly $typeName = RuleKey.$typeName;
  readonly $fullTypeName: `${typeof PKG_V35}::token::RuleKey<${PhantomToTypeStr<T0>}>`;
  ...
  private constructor(
    ...
    this.$fullTypeName = composeSuiType(
      RuleKey.$typeName,
      ...typeArgs,
    ) as `${typeof PKG_V35}::token::RuleKey<${PhantomToTypeStr<T0>}>`;
  ...
  static reified<T0 extends PhantomReified<PhantomTypeArgument>>(
    ...
    return {
      ...
      fullTypeName: composeSuiType(
        RuleKey.$typeName,
        ...[extractType(T0)],
      ) as `${typeof PKG_V35}::token::RuleKey<${PhantomToTypeStr<ToPhantomTypeArgument<T0>>}>`,
