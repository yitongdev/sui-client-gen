...
export function isGT(type: string): boolean {
  ...
  return type === `${PKG_V35}::bls12381::GT`;
}
...
export class GT implements StructClass {
  ...
  static readonly $typeName = `${PKG_V35}::bls12381::GT`;
  static readonly $numTypeParams = 0;
  static readonly $isPhantom = [] as const;

  readonly $typeName = GT.$typeName;
  readonly $fullTypeName: `${typeof PKG_V35}::bls12381::GT`;
  readonly $typeArgs: [];
  ...
  static reified(): GTReified {
    return {
      ...
      fullTypeName: composeSuiType(GT.$typeName, ...[]) as `${typeof PKG_V35}::bls12381::GT`,
      typeArgs: [] as [],
