...
export function isTransferPolicy(type: string): boolean {
  ...
  return type.startsWith(`${PKG_V35}::transfer_policy::TransferPolicy` + "<");
}
  ...
  implements StructClass
{
  ...
  static readonly $typeName = `${PKG_V35}::transfer_policy::TransferPolicy`;
  static readonly $numTypeParams = 1;
  static readonly $isPhantom = [true] as const;

  readonly $typeName = TransferPolicy.$typeName;
  readonly $fullTypeName: `${typeof PKG_V35}::transfer_policy::TransferPolicy<${PhantomToTypeStr<T0>}>`;
  ...
  private constructor(
    ...
    this.$fullTypeName = composeSuiType(
      ...
      ...typeArgs,
    ) as `${typeof PKG_V35}::transfer_policy::TransferPolicy<${PhantomToTypeStr<T0>}>`;
  ...
  static reified<T0 extends PhantomReified<PhantomTypeArgument>>(
    ...
    return {
      ...
      fullTypeName: composeSuiType(
        TransferPolicy.$typeName,
        ...[extractType(T0)],
      ) as `${typeof PKG_V35}::transfer_policy::TransferPolicy<${PhantomToTypeStr<ToPhantomTypeArgument<T0>>}>`,
