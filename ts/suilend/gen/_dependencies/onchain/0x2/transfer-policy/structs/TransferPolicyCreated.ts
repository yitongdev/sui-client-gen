...
export function isTransferPolicyCreated(type: string): boolean {
  ...
  return type.startsWith(`${PKG_V35}::transfer_policy::TransferPolicyCreated` + "<");
}
...
export class TransferPolicyCreated<T0 extends PhantomTypeArgument> implements StructClass {
  ...
  static readonly $typeName = `${PKG_V35}::transfer_policy::TransferPolicyCreated`;
  static readonly $numTypeParams = 1;
  static readonly $isPhantom = [true] as const;

  readonly $typeName = TransferPolicyCreated.$typeName;
  readonly $fullTypeName: `${typeof PKG_V35}::transfer_policy::TransferPolicyCreated<${PhantomToTypeStr<T0>}>`;
  ...
  private constructor(typeArgs: [PhantomToTypeStr<T0>], fields: TransferPolicyCreatedFields<T0>) {
    this.$fullTypeName = composeSuiType(
      ...
      ...typeArgs,
    ) as `${typeof PKG_V35}::transfer_policy::TransferPolicyCreated<${PhantomToTypeStr<T0>}>`;
  ...
  static reified<T0 extends PhantomReified<PhantomTypeArgument>>(
    ...
    return {
      ...
      fullTypeName: composeSuiType(
        TransferPolicyCreated.$typeName,
        ...[extractType(T0)],
      ) as `${typeof PKG_V35}::transfer_policy::TransferPolicyCreated<${PhantomToTypeStr<ToPhantomTypeArgument<T0>>}>`,
