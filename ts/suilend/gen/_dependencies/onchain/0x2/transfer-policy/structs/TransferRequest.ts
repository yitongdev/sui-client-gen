...
export function isTransferRequest(type: string): boolean {
  ...
  return type.startsWith(`${PKG_V35}::transfer_policy::TransferRequest` + "<");
}
  ...
  implements StructClass
{
  ...
  static readonly $typeName = `${PKG_V35}::transfer_policy::TransferRequest`;
  static readonly $numTypeParams = 1;
  static readonly $isPhantom = [true] as const;

  readonly $typeName = TransferRequest.$typeName;
  readonly $fullTypeName: `${typeof PKG_V35}::transfer_policy::TransferRequest<${PhantomToTypeStr<T0>}>`;
  ...
  private constructor(
    ...
    this.$fullTypeName = composeSuiType(
      ...
      ...typeArgs,
    ) as `${typeof PKG_V35}::transfer_policy::TransferRequest<${PhantomToTypeStr<T0>}>`;
  ...
  static reified<T0 extends PhantomReified<PhantomTypeArgument>>(
    ...
    return {
      ...
      fullTypeName: composeSuiType(
        TransferRequest.$typeName,
        ...[extractType(T0)],
      ) as `${typeof PKG_V35}::transfer_policy::TransferRequest<${PhantomToTypeStr<ToPhantomTypeArgument<T0>>}>`,
