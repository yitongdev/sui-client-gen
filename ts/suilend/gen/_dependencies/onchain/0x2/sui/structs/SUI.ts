...
export class SUI implements StructClass {
  ...
  static readonly $typeName = `${PKG_V35}::sui::SUI`;
  static readonly $numTypeParams = 0;
  static readonly $isPhantom = [] as const;

  readonly $typeName = SUI.$typeName;
  readonly $fullTypeName: `${typeof PKG_V35}::sui::SUI`;
  readonly $typeArgs: [];
  ...
  static reified(): SUIReified {
    return {
      ...
      fullTypeName: composeSuiType(SUI.$typeName, ...[]) as `${typeof PKG_V35}::sui::SUI`,
      typeArgs: [] as [],
