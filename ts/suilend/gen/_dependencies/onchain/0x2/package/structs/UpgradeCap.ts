...
export function isUpgradeCap(type: string): boolean {
  ...
  return type === `${PKG_V35}::package::UpgradeCap`;
}
...
export class UpgradeCap implements StructClass {
  ...
  static readonly $typeName = `${PKG_V35}::package::UpgradeCap`;
  static readonly $numTypeParams = 0;
  static readonly $isPhantom = [] as const;

  readonly $typeName = UpgradeCap.$typeName;
  readonly $fullTypeName: `${typeof PKG_V35}::package::UpgradeCap`;
  readonly $typeArgs: [];
  ...
  private constructor(typeArgs: [], fields: UpgradeCapFields) {
    this.$fullTypeName = composeSuiType(
      UpgradeCap.$typeName,
      ...typeArgs,
    ) as `${typeof PKG_V35}::package::UpgradeCap`;
