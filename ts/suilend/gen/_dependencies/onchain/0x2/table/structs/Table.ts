...
export function isTable(type: string): boolean {
  ...
  return type.startsWith(`${PKG_V35}::table::Table` + "<");
}
...
export type TableReified<
  T0 extends PhantomTypeArgument,
  T1 extends PhantomTypeArgument,
> = Reified<Table<T0, T1>, TableFields<T0, T1>>;
...
> implements StructClass
{
  ...
  static readonly $typeName = `${PKG_V35}::table::Table`;
  static readonly $numTypeParams = 2;
  static readonly $isPhantom = [true, true] as const;

  readonly $typeName = Table.$typeName;
  readonly $fullTypeName: `${typeof PKG_V35}::table::Table<${PhantomToTypeStr<T0>}, ${PhantomToTypeStr<T1>}>`;
  ...
  private constructor(
    ...
    this.$fullTypeName = composeSuiType(
      Table.$typeName,
      ...typeArgs,
    ) as `${typeof PKG_V35}::table::Table<${PhantomToTypeStr<T0>}, ${PhantomToTypeStr<T1>}>`;
  ...
  >(
    T0: T0,
    T1: T1,
  ): TableReified<ToPhantomTypeArgument<T0>, ToPhantomTypeArgument<T1>> {
    return {
      typeName: Table.$typeName,
      fullTypeName: composeSuiType(
        Table.$typeName,
        ...[extractType(T0), extractType(T1)],
      ) as `${typeof PKG_V35}::table::Table<${PhantomToTypeStr<ToPhantomTypeArgument<T0>>}, ${PhantomToTypeStr<ToPhantomTypeArgument<T1>>}>`,
      ...
      fromFields: (fields: Record<string, any>) =>
        Table.fromFields([T0, T1], fields),
      fromFieldsWithTypes: (item: FieldsWithTypes) =>
        Table.fromFieldsWithTypes([T0, T1], item),
      ...
      fromSuiParsedData: (content: SuiParsedData) =>
        Table.fromSuiParsedData([T0, T1], content),
      fromSuiObjectData: (content: SuiObjectData) =>
        Table.fromSuiObjectData([T0, T1], content),
      fetch: async (client: SuiClient, id: string) =>
        Table.fetch(client, [T0, T1], id),
      new: (
        fields: TableFields<
  ...
  >(
    ...
    ToTypeStr<Table<ToPhantomTypeArgument<T0>, ToPhantomTypeArgument<T1>>>
  > {
