...
export function isBorrow(type: string): boolean {
  ...
  return type === `${PKG_V35}::kiosk::Borrow`;
}
...
export class Borrow implements StructClass {
  ...
  static readonly $typeName = `${PKG_V35}::kiosk::Borrow`;
  static readonly $numTypeParams = 0;
  static readonly $isPhantom = [] as const;

  readonly $typeName = Borrow.$typeName;
  readonly $fullTypeName: `${typeof PKG_V35}::kiosk::Borrow`;
  readonly $typeArgs: [];
  ...
  private constructor(typeArgs: [], fields: BorrowFields) {
    this.$fullTypeName = composeSuiType(
      Borrow.$typeName,
      ...typeArgs,
    ) as `${typeof PKG_V35}::kiosk::Borrow`;
  ...
  static reified(): BorrowReified {
    return {
      ...
      fullTypeName: composeSuiType(Borrow.$typeName, ...[]) as `${typeof PKG_V35}::kiosk::Borrow`,
      typeArgs: [] as [],
