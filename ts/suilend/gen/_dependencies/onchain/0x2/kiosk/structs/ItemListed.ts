...
export function isItemListed(type: string): boolean {
  ...
  return type.startsWith(`${PKG_V35}::kiosk::ItemListed` + "<");
}
...
export class ItemListed<T0 extends PhantomTypeArgument> implements StructClass {
  ...
  static readonly $typeName = `${PKG_V35}::kiosk::ItemListed`;
  static readonly $numTypeParams = 1;
  static readonly $isPhantom = [true] as const;

  readonly $typeName = ItemListed.$typeName;
  readonly $fullTypeName: `${typeof PKG_V35}::kiosk::ItemListed<${PhantomToTypeStr<T0>}>`;
  ...
  private constructor(
    ...
    this.$fullTypeName = composeSuiType(
      ItemListed.$typeName,
      ...typeArgs,
    ) as `${typeof PKG_V35}::kiosk::ItemListed<${PhantomToTypeStr<T0>}>`;
  ...
  static reified<T0 extends PhantomReified<PhantomTypeArgument>>(
    ...
    return {
      ...
      fullTypeName: composeSuiType(
        ItemListed.$typeName,
        ...[extractType(T0)],
      ) as `${typeof PKG_V35}::kiosk::ItemListed<${PhantomToTypeStr<ToPhantomTypeArgument<T0>>}>`,
