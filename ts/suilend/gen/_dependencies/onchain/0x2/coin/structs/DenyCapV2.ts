...
export function isDenyCapV2(type: string): boolean {
  ...
  return type.startsWith(`${PKG_V35}::coin::DenyCapV2` + "<");
}
...
export class DenyCapV2<T0 extends PhantomTypeArgument> implements StructClass {
  ...
  static readonly $typeName = `${PKG_V35}::coin::DenyCapV2`;
  static readonly $numTypeParams = 1;
  static readonly $isPhantom = [true] as const;

  readonly $typeName = DenyCapV2.$typeName;
  readonly $fullTypeName: `${typeof PKG_V35}::coin::DenyCapV2<${PhantomToTypeStr<T0>}>`;
  ...
  private constructor(typeArgs: [PhantomToTypeStr<T0>], fields: DenyCapV2Fields<T0>) {
    this.$fullTypeName = composeSuiType(
      DenyCapV2.$typeName,
      ...typeArgs,
    ) as `${typeof PKG_V35}::coin::DenyCapV2<${PhantomToTypeStr<T0>}>`;
