...
export function isCoin(type: string): boolean {
  ...
  return type.startsWith(`${PKG_V35}::coin::Coin` + "<");
}
...
export class Coin<T0 extends PhantomTypeArgument> implements StructClass {
  ...
  static readonly $typeName = `${PKG_V35}::coin::Coin`;
  static readonly $numTypeParams = 1;
  static readonly $isPhantom = [true] as const;

  readonly $typeName = Coin.$typeName;
  readonly $fullTypeName: `${typeof PKG_V35}::coin::Coin<${PhantomToTypeStr<T0>}>`;
  ...
  private constructor(
    ...
    this.$fullTypeName = composeSuiType(
      Coin.$typeName,
      ...typeArgs,
    ) as `${typeof PKG_V35}::coin::Coin<${PhantomToTypeStr<T0>}>`;
  ...
  static reified<T0 extends PhantomReified<PhantomTypeArgument>>(
    ...
    return {
      ...
      fullTypeName: composeSuiType(
        Coin.$typeName,
        ...[extractType(T0)],
      ) as `${typeof PKG_V35}::coin::Coin<${PhantomToTypeStr<ToPhantomTypeArgument<T0>>}>`,
