...
import { String as String1 } from "../../../0x1/ascii/structs/index.js";
...
export function isCoinMetadata(type: string): boolean {
  ...
  return type.startsWith(`${PKG_V35}::coin::CoinMetadata` + "<");
}
  ...
  implements StructClass
{
  ...
  static readonly $typeName = `${PKG_V35}::coin::CoinMetadata`;
  static readonly $numTypeParams = 1;
  static readonly $isPhantom = [true] as const;

  readonly $typeName = CoinMetadata.$typeName;
  readonly $fullTypeName: `${typeof PKG_V35}::coin::CoinMetadata<${PhantomToTypeStr<T0>}>`;
  ...
  private constructor(
    ...
    this.$fullTypeName = composeSuiType(
      ...
      ...typeArgs,
    ) as `${typeof PKG_V35}::coin::CoinMetadata<${PhantomToTypeStr<T0>}>`;
  ...
  static reified<T0 extends PhantomReified<PhantomTypeArgument>>(
    ...
    return {
      ...
      fullTypeName: composeSuiType(
        CoinMetadata.$typeName,
        ...[extractType(T0)],
      ) as `${typeof PKG_V35}::coin::CoinMetadata<${PhantomToTypeStr<ToPhantomTypeArgument<T0>>}>`,
