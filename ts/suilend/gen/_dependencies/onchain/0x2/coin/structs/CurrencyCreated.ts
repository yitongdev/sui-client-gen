...
export function isCurrencyCreated(type: string): boolean {
  ...
  return type.startsWith(`${PKG_V35}::coin::CurrencyCreated` + "<");
}
  ...
  implements StructClass
{
  ...
  static readonly $typeName = `${PKG_V35}::coin::CurrencyCreated`;
  static readonly $numTypeParams = 1;
  static readonly $isPhantom = [true] as const;

  readonly $typeName = CurrencyCreated.$typeName;
  readonly $fullTypeName: `${typeof PKG_V35}::coin::CurrencyCreated<${PhantomToTypeStr<T0>}>`;
  ...
  private constructor(
    ...
    this.$fullTypeName = composeSuiType(
      ...
      ...typeArgs,
    ) as `${typeof PKG_V35}::coin::CurrencyCreated<${PhantomToTypeStr<T0>}>`;
  ...
  static reified<T0 extends PhantomReified<PhantomTypeArgument>>(
    ...
    return {
      ...
      fullTypeName: composeSuiType(
        CurrencyCreated.$typeName,
        ...[extractType(T0)],
      ) as `${typeof PKG_V35}::coin::CurrencyCreated<${PhantomToTypeStr<ToPhantomTypeArgument<T0>>}>`,
