...
export function isAuthenticatorStateInner(type: string): boolean {
  ...
  return type === `${PKG_V35}::authenticator_state::AuthenticatorStateInner`;
}
...
export class AuthenticatorStateInner implements StructClass {
  ...
  static readonly $typeName = `${PKG_V35}::authenticator_state::AuthenticatorStateInner`;
  static readonly $numTypeParams = 0;
  static readonly $isPhantom = [] as const;

  readonly $typeName = AuthenticatorStateInner.$typeName;
  readonly $fullTypeName: `${typeof PKG_V35}::authenticator_state::AuthenticatorStateInner`;
  readonly $typeArgs: [];
  ...
  private constructor(typeArgs: [], fields: AuthenticatorStateInnerFields) {
    this.$fullTypeName = composeSuiType(
      ...
      ...typeArgs,
    ) as `${typeof PKG_V35}::authenticator_state::AuthenticatorStateInner`;
