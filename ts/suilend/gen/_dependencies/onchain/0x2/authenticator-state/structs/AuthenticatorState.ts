...
export function isAuthenticatorState(type: string): boolean {
  ...
  return type === `${PKG_V35}::authenticator_state::AuthenticatorState`;
}
...
export class AuthenticatorState implements StructClass {
  ...
  static readonly $typeName = `${PKG_V35}::authenticator_state::AuthenticatorState`;
  static readonly $numTypeParams = 0;
  static readonly $isPhantom = [] as const;

  readonly $typeName = AuthenticatorState.$typeName;
  readonly $fullTypeName: `${typeof PKG_V35}::authenticator_state::AuthenticatorState`;
  readonly $typeArgs: [];
  ...
  private constructor(typeArgs: [], fields: AuthenticatorStateFields) {
    this.$fullTypeName = composeSuiType(
      ...
      ...typeArgs,
    ) as `${typeof PKG_V35}::authenticator_state::AuthenticatorState`;
