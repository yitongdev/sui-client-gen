...
export function isWrapper(type: string): boolean {
  ...
  return type.startsWith(`${PKG_V35}::dynamic_object_field::Wrapper` + "<");
}
...
export class Wrapper<T0 extends TypeArgument> implements StructClass {
  ...
  static readonly $typeName = `${PKG_V35}::dynamic_object_field::Wrapper`;
  static readonly $numTypeParams = 1;
  static readonly $isPhantom = [false] as const;

  readonly $typeName = Wrapper.$typeName;
  readonly $fullTypeName: `${typeof PKG_V35}::dynamic_object_field::Wrapper<${ToTypeStr<T0>}>`;
  ...
  private constructor(typeArgs: [ToTypeStr<T0>], fields: WrapperFields<T0>) {
    this.$fullTypeName = composeSuiType(
      Wrapper.$typeName,
      ...typeArgs,
    ) as `${typeof PKG_V35}::dynamic_object_field::Wrapper<${ToTypeStr<T0>}>`;
  ...
  static reified<T0 extends Reified<TypeArgument, any>>(
    ...
    return {
      ...
      fullTypeName: composeSuiType(
        Wrapper.$typeName,
        ...[extractType(T0)],
      ) as `${typeof PKG_V35}::dynamic_object_field::Wrapper<${ToTypeStr<ToTypeArgument<T0>>}>`,
