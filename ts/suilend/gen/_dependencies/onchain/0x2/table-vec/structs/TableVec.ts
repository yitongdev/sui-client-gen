...
export function isTableVec(type: string): boolean {
  ...
  return type.startsWith(`${PKG_V35}::table_vec::TableVec` + "<");
}
...
export class TableVec<T0 extends PhantomTypeArgument> implements StructClass {
  ...
  static readonly $typeName = `${PKG_V35}::table_vec::TableVec`;
  static readonly $numTypeParams = 1;
  static readonly $isPhantom = [true] as const;

  readonly $typeName = TableVec.$typeName;
  readonly $fullTypeName: `${typeof PKG_V35}::table_vec::TableVec<${PhantomToTypeStr<T0>}>`;
  ...
  private constructor(
    ...
    fields: TableVecFields<T0>,
  ) {
    this.$fullTypeName = composeSuiType(
      TableVec.$typeName,
      ...typeArgs,
    ) as `${typeof PKG_V35}::table_vec::TableVec<${PhantomToTypeStr<T0>}>`;
  ...
  static reified<T0 extends PhantomReified<PhantomTypeArgument>>(
    ...
    return {
      ...
      fullTypeName: composeSuiType(
        TableVec.$typeName,
        ...[extractType(T0)],
      ) as `${typeof PKG_V35}::table_vec::TableVec<${PhantomToTypeStr<ToPhantomTypeArgument<T0>>}>`,
      ...
      fromFields: (fields: Record<string, any>) =>
        TableVec.fromFields(T0, fields),
      fromFieldsWithTypes: (item: FieldsWithTypes) =>
        TableVec.fromFieldsWithTypes(T0, item),
      ...
      fromSuiParsedData: (content: SuiParsedData) =>
        TableVec.fromSuiParsedData(T0, content),
      fromSuiObjectData: (content: SuiObjectData) =>
        TableVec.fromSuiObjectData(T0, content),
      fetch: async (client: SuiClient, id: string) =>
        TableVec.fetch(client, T0, id),
