...
export function isVersionUpdated(type: string): boolean {
  ...
  return type.startsWith(`${PKG_V35}::display::VersionUpdated` + "<");
}
  ...
  implements StructClass
{
  ...
  static readonly $typeName = `${PKG_V35}::display::VersionUpdated`;
  static readonly $numTypeParams = 1;
  static readonly $isPhantom = [true] as const;

  readonly $typeName = VersionUpdated.$typeName;
  readonly $fullTypeName: `${typeof PKG_V35}::display::VersionUpdated<${PhantomToTypeStr<T0>}>`;
  ...
  private constructor(
    ...
    this.$fullTypeName = composeSuiType(
      ...
      ...typeArgs,
    ) as `${typeof PKG_V35}::display::VersionUpdated<${PhantomToTypeStr<T0>}>`;
  ...
  static reified<T0 extends PhantomReified<PhantomTypeArgument>>(
    ...
    return {
      ...
      fullTypeName: composeSuiType(
        VersionUpdated.$typeName,
        ...[extractType(T0)],
      ) as `${typeof PKG_V35}::display::VersionUpdated<${PhantomToTypeStr<ToPhantomTypeArgument<T0>>}>`,
