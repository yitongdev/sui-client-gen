...
export function isDisplayCreated(type: string): boolean {
  ...
  return type.startsWith(`${PKG_V35}::display::DisplayCreated` + "<");
}
  ...
  implements StructClass
{
  ...
  static readonly $typeName = `${PKG_V35}::display::DisplayCreated`;
  static readonly $numTypeParams = 1;
  static readonly $isPhantom = [true] as const;

  readonly $typeName = DisplayCreated.$typeName;
  readonly $fullTypeName: `${typeof PKG_V35}::display::DisplayCreated<${PhantomToTypeStr<T0>}>`;
  ...
  private constructor(
    ...
    fields: DisplayCreatedFields<T0>,
  ) {
    this.$fullTypeName = composeSuiType(
      DisplayCreated.$typeName,
      ...typeArgs,
    ) as `${typeof PKG_V35}::display::DisplayCreated<${PhantomToTypeStr<T0>}>`;
  ...
  static reified<T0 extends PhantomReified<PhantomTypeArgument>>(
    ...
    return {
      ...
      fullTypeName: composeSuiType(
        DisplayCreated.$typeName,
        ...[extractType(T0)],
      ) as `${typeof PKG_V35}::display::DisplayCreated<${PhantomToTypeStr<ToPhantomTypeArgument<T0>>}>`,
      ...
      fromFields: (fields: Record<string, any>) =>
        DisplayCreated.fromFields(T0, fields),
      fromFieldsWithTypes: (item: FieldsWithTypes) =>
        DisplayCreated.fromFieldsWithTypes(T0, item),
      ...
      fromJSON: (json: Record<string, any>) =>
        DisplayCreated.fromJSON(T0, json),
      fromSuiParsedData: (content: SuiParsedData) =>
        DisplayCreated.fromSuiParsedData(T0, content),
      fromSuiObjectData: (content: SuiObjectData) =>
        DisplayCreated.fromSuiObjectData(T0, content),
      fetch: async (client: SuiClient, id: string) =>
        DisplayCreated.fetch(client, T0, id),
