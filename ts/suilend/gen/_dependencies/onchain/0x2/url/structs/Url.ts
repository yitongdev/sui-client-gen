...
export class Url implements StructClass {
  ...
  static readonly $typeName = `${PKG_V35}::url::Url`;
  static readonly $numTypeParams = 0;
  static readonly $isPhantom = [] as const;

  readonly $typeName = Url.$typeName;
  readonly $fullTypeName: `${typeof PKG_V35}::url::Url`;
  readonly $typeArgs: [];
  ...
  static reified(): UrlReified {
    return {
      ...
      fullTypeName: composeSuiType(Url.$typeName, ...[]) as `${typeof PKG_V35}::url::Url`,
      typeArgs: [] as [],
