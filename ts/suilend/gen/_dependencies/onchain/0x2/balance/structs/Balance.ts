...
export function isBalance(type: string): boolean {
  ...
  return type.startsWith(`${PKG_V35}::balance::Balance` + "<");
}
...
export class Balance<T0 extends PhantomTypeArgument> implements StructClass {
  ...
  static readonly $typeName = `${PKG_V35}::balance::Balance`;
  static readonly $numTypeParams = 1;
  static readonly $isPhantom = [true] as const;

  readonly $typeName = Balance.$typeName;
  readonly $fullTypeName: `${typeof PKG_V35}::balance::Balance<${PhantomToTypeStr<T0>}>`;
  ...
  private constructor(
    ...
    this.$fullTypeName = composeSuiType(
      Balance.$typeName,
      ...typeArgs,
    ) as `${typeof PKG_V35}::balance::Balance<${PhantomToTypeStr<T0>}>`;
