 ...
 */
export class WeightHookAdminCap<T0 extends PhantomTypeArgument>
  implements StructClass
{
  ...
  private constructor(
    ...
    fields: WeightHookAdminCapFields<T0>,
  ) {
  ...
  static reified<T0 extends PhantomReified<PhantomTypeArgument>>(
    ...
    return {
      ...
      fromFields: (fields: Record<string, any>) =>
        WeightHookAdminCap.fromFields(T0, fields),
