...
export function nativeSender(tx: Transaction) {
  return tx.moveCall({
    target: `${PUBLISHED_AT}::tx_context::native_sender`,
    arguments: [],
  });
}
...
export function sponsor(tx: Transaction) {
  return tx.moveCall({
    target: `${PUBLISHED_AT}::tx_context::sponsor`,
    arguments: [],
  });
}
...
export function freshId(tx: Transaction) {
  return tx.moveCall({
    target: `${PUBLISHED_AT}::tx_context::fresh_id`,
    arguments: [],
  });
}
...
export function nativeIdsCreated(tx: Transaction) {
  return tx.moveCall({
    target: `${PUBLISHED_AT}::tx_context::native_ids_created`,
    arguments: [],
  });
}
...
export function nativeGasPrice(tx: Transaction) {
  return tx.moveCall({
    target: `${PUBLISHED_AT}::tx_context::native_gas_price`,
    arguments: [],
  });
}
...
export function optionSponsor(tx: Transaction) {
  return tx.moveCall({
    target: `${PUBLISHED_AT}::tx_context::option_sponsor`,
    arguments: [],
  });
}
