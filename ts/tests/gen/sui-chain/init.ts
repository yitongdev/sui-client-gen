import * as authenticatorState from "./authenticator-state/structs.js";
import * as bag from "./bag/structs.js";
import * as balance from "./balance/structs.js";
import * as bcs from "./bcs/structs.js";
import * as bls12381 from "./bls12381/structs.js";
import * as borrow from "./borrow/structs.js";
import * as clock from "./clock/structs.js";
import * as coin from "./coin/structs.js";
import * as config from "./config/structs.js";
import * as denyList from "./deny-list/structs.js";
import * as display from "./display/structs.js";
import * as dynamicField from "./dynamic-field/structs.js";
import * as dynamicObjectField from "./dynamic-object-field/structs.js";
import * as groth16 from "./groth16/structs.js";
import * as groupOps from "./group-ops/structs.js";
import * as kioskExtension from "./kiosk-extension/structs.js";
import * as kiosk from "./kiosk/structs.js";
import * as linkedTable from "./linked-table/structs.js";
import * as nitroAttestation from "./nitro-attestation/structs.js";
import * as objectBag from "./object-bag/structs.js";
import * as objectTable from "./object-table/structs.js";
import * as object from "./object/structs.js";
import * as package_ from "./package/structs.js";
import * as party from "./party/structs.js";
import * as priorityQueue from "./priority-queue/structs.js";
import * as random from "./random/structs.js";
import * as sui from "./sui/structs.js";
import * as tableVec from "./table-vec/structs.js";
import * as table from "./table/structs.js";
import * as token from "./token/structs.js";
import * as transferPolicy from "./transfer-policy/structs.js";
import * as transfer from "./transfer/structs.js";
import * as txContext from "./tx-context/structs.js";
import * as url from "./url/structs.js";
import * as vecMap from "./vec-map/structs.js";
import * as vecSet from "./vec-set/structs.js";
import * as versioned from "./versioned/structs.js";
import * as zkloginVerifiedId from "./zklogin-verified-id/structs.js";
import * as zkloginVerifiedIssuer from "./zklogin-verified-issuer/structs.js";
