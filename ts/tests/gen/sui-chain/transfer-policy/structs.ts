  ...
  implements StructClass
{
  ...
  private constructor(
    ...
    fields: TransferRequestFields<T0>,
  ) {
  ...
  static reified<T0 extends PhantomReified<PhantomTypeArgument>>(
    ...
    return {
      ...
      fromFields: (fields: Record<string, any>) =>
        TransferRequest.fromFields(T0, fields),
      fromFieldsWithTypes: (item: FieldsWithTypes) =>
        TransferRequest.fromFieldsWithTypes(T0, item),
      ...
      fromJSON: (json: Record<string, any>) =>
        TransferRequest.fromJSON(T0, json),
      fromSuiParsedData: (content: SuiParsedData) =>
        TransferRequest.fromSuiParsedData(T0, content),
      fromSuiObjectData: (content: SuiObjectData) =>
        TransferRequest.fromSuiObjectData(T0, content),
      fetch: async (client: SuiClient, id: string) =>
        TransferRequest.fetch(client, T0, id),
  ...
  implements StructClass
{
  ...
  private constructor(
    typeArgs: [PhantomToTypeStr<T0>],
    fields: TransferPolicyFields<T0>,
  ) {
    this.$fullTypeName = composeSuiType(
  ...
  static reified<T0 extends PhantomReified<PhantomTypeArgument>>(
    ...
    return {
      ...
      reifiedTypeArgs: [T0],
      fromFields: (fields: Record<string, any>) =>
        TransferPolicy.fromFields(T0, fields),
      fromFieldsWithTypes: (item: FieldsWithTypes) =>
        TransferPolicy.fromFieldsWithTypes(T0, item),
      ...
      fromJSON: (json: Record<string, any>) =>
        TransferPolicy.fromJSON(T0, json),
      fromSuiParsedData: (content: SuiParsedData) =>
        TransferPolicy.fromSuiParsedData(T0, content),
      fromSuiObjectData: (content: SuiObjectData) =>
        TransferPolicy.fromSuiObjectData(T0, content),
      fetch: async (client: SuiClient, id: string) =>
        TransferPolicy.fetch(client, T0, id),
...
export class RuleKey<T0 extends PhantomTypeArgument> implements StructClass {
  ...
  static reified<T0 extends PhantomReified<PhantomTypeArgument>>(
    ...
    return {
      ...
      reifiedTypeArgs: [T0],
      fromFields: (fields: Record<string, any>) =>
        RuleKey.fromFields(T0, fields),
      fromFieldsWithTypes: (item: FieldsWithTypes) =>
        RuleKey.fromFieldsWithTypes(T0, item),
      ...
      fromSuiParsedData: (content: SuiParsedData) =>
        RuleKey.fromSuiParsedData(T0, content),
      fromSuiObjectData: (content: SuiObjectData) =>
        RuleKey.fromSuiObjectData(T0, content),
      fetch: async (client: SuiClient, id: string) =>
        RuleKey.fetch(client, T0, id),
