...
import { String as String1 } from "../../move-stdlib-chain/ascii/structs.js";
...
export type CoinReified<T0 extends PhantomTypeArgument> = Reified<
  Coin<T0>,
  CoinFields<T0>
>;
  ...
  static reified<T0 extends PhantomReified<PhantomTypeArgument>>(
    ...
    return {
      ...
      fromFieldsWithTypes: (item: FieldsWithTypes) =>
        Coin.fromFieldsWithTypes(T0, item),
      ...
      fromSuiParsedData: (content: SuiParsedData) =>
        Coin.fromSuiParsedData(T0, content),
      fromSuiObjectData: (content: SuiObjectData) =>
        Coin.fromSuiObjectData(T0, content),
      fetch: async (client: SuiClient, id: string) =>
        Coin.fetch(client, T0, id),
...
export type RegulatedCoinMetadataReified<T0 extends PhantomTypeArgument> =
  Reified<RegulatedCoinMetadata<T0>, RegulatedCoinMetadataFields<T0>>;
  ...
  implements StructClass
{
  ...
  private constructor(
    typeArgs: [PhantomToTypeStr<T0>],
    fields: RegulatedCoinMetadataFields<T0>,
  ) {
    this.$fullTypeName = composeSuiType(
  ...
  static reified<T0 extends PhantomReified<PhantomTypeArgument>>(
    ...
    return {
      ...
      reifiedTypeArgs: [T0],
      fromFields: (fields: Record<string, any>) =>
        RegulatedCoinMetadata.fromFields(T0, fields),
      fromFieldsWithTypes: (item: FieldsWithTypes) =>
      ...
      fromJSONField: (field: any) =>
        RegulatedCoinMetadata.fromJSONField(T0, field),
      fromJSON: (json: Record<string, any>) =>
        RegulatedCoinMetadata.fromJSON(T0, json),
      fromSuiParsedData: (content: SuiParsedData) =>
        RegulatedCoinMetadata.fromSuiParsedData(T0, content),
      fromSuiObjectData: (content: SuiObjectData) =>
        RegulatedCoinMetadata.fromSuiObjectData(T0, content),
      fetch: async (client: SuiClient, id: string) =>
        RegulatedCoinMetadata.fetch(client, T0, id),
  ...
  static phantom<T0 extends PhantomReified<PhantomTypeArgument>>(
    ...
    ToTypeStr<RegulatedCoinMetadata<ToPhantomTypeArgument<T0>>>
  > {
  ...
  implements StructClass
{
  ...
  private constructor(
    typeArgs: [PhantomToTypeStr<T0>],
    fields: CurrencyCreatedFields<T0>,
  ) {
    this.$fullTypeName = composeSuiType(
  ...
  static reified<T0 extends PhantomReified<PhantomTypeArgument>>(
    ...
    return {
      ...
      reifiedTypeArgs: [T0],
      fromFields: (fields: Record<string, any>) =>
        CurrencyCreated.fromFields(T0, fields),
      fromFieldsWithTypes: (item: FieldsWithTypes) =>
        CurrencyCreated.fromFieldsWithTypes(T0, item),
      ...
      fromJSON: (json: Record<string, any>) =>
        CurrencyCreated.fromJSON(T0, json),
      fromSuiParsedData: (content: SuiParsedData) =>
        CurrencyCreated.fromSuiParsedData(T0, content),
      fromSuiObjectData: (content: SuiObjectData) =>
        CurrencyCreated.fromSuiObjectData(T0, content),
      fetch: async (client: SuiClient, id: string) =>
        CurrencyCreated.fetch(client, T0, id),
...
export class DenyCap<T0 extends PhantomTypeArgument> implements StructClass {
  ...
  static reified<T0 extends PhantomReified<PhantomTypeArgument>>(
    ...
    return {
      ...
      reifiedTypeArgs: [T0],
      fromFields: (fields: Record<string, any>) =>
        DenyCap.fromFields(T0, fields),
      fromFieldsWithTypes: (item: FieldsWithTypes) =>
        DenyCap.fromFieldsWithTypes(T0, item),
      ...
      fromSuiParsedData: (content: SuiParsedData) =>
        DenyCap.fromSuiParsedData(T0, content),
      fromSuiObjectData: (content: SuiObjectData) =>
        DenyCap.fromSuiObjectData(T0, content),
      fetch: async (client: SuiClient, id: string) =>
        DenyCap.fetch(client, T0, id),
