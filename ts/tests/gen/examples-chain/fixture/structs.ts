...
import { Balance } from "../../sui-chain/balance/structs.js";
...
export type FooReified<T0 extends TypeArgument> = Reified<
  Foo<T0>,
  FooFields<T0>
>;
...
export class Foo<T0 extends TypeArgument> implements StructClass {
  ...
  readonly twoGenericsNested: ToField<
    WithTwoGenerics<T0, WithTwoGenerics<"u8", "u8">>
  >;
  ...
  static reified<T0 extends Reified<TypeArgument, any>>(
    ...
    return {
      ...
      fromFieldsWithTypes: (item: FieldsWithTypes) =>
        Foo.fromFieldsWithTypes(T0, item),
      ...
      fromSuiParsedData: (content: SuiParsedData) =>
        Foo.fromSuiParsedData(T0, content),
      fromSuiObjectData: (content: SuiObjectData) =>
        Foo.fromSuiObjectData(T0, content),
    ...
    return <T0 extends BcsType<any>>(T0: T0) =>
      bcs.struct(`Foo<${T0.name}>`, {
        ...
        two_generics_nested_vec: bcs.vector(
          WithTwoGenerics.bcs(
            Bar.bcs,
            bcs.vector(WithTwoGenerics.bcs(T0, bcs.u8())),
          ),
        ),
        dummy: Dummy.bcs,
  ...
  toJSONField() {
    return {
      ...
      genericVec: fieldToJSON<Vector<T0>>(
